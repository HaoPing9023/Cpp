...
//	my::priority_queue<int, vector<int>, Greater<int>> pq;
...
//	// 需要自己实现仿函数
//
//	//my::priority_queue<Date*, vector<Date*>, DateLess> q2;
//	my::priority_queue<Date*> q2;
